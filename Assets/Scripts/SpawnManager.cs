/// Project "Spawning" created, and this Script written by Karl Krieger gameproject.unite@gmail.com
/// ©All rights reserved.
/// 
/// If you want to use this for commercial or uncommercial use, it would be polite
/// if you send me a link (via email, or message me at www.armedunity.com) to your project update page or youtube channel (or other),
/// just so i would know were this stuff is being used.
/// 
/// I might ask to add me to youtube description (if its youtube), or other informative
/// description block, if i find it necessary.
/// 
/// Otherwise, it will be considered as unauthorized use. For which every time you do, a puppy dies.
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public class SpawnManager : MonoBehaviour {
						...
						for(int j =0; j <spawnPointIndexes.Length; j++){
							...
							if(spawnPositions[spawnArrIndex].canBeUsed){
								...
								if(spawnPositions[spawnArrIndex].position.gameObject.GetComponent<Spawn>().Status()){
                                    ...
                                    cachedEnemy.GetComponent<EnemyControllerZumbi>().Set(this.gameObject);
	...
	private void OnGUI(){
        ...
        GUI.Label(new Rect(200, 10, 100, 100), currentlyAlive.ToString());
