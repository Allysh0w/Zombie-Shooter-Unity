...
public class MSP{
	...
	public void OnGUIComponents(){
		...
		//Fire Button
		Fire.FingerBound = new Rect( (float)1.2*(FixePos.x-PadSize*PadSizeCorrector/2+FireBtnPosCorrector.x) ,(float)0.11 * ( FixePos.y - PadSize*PadSizeCorrector/2-FireBtnPosCorrector.y), PadSize*PadSizeCorrector,PadSize*PadSizeCorrector);
